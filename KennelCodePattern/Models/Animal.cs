...
namespace KennelCodePattern.Models
{
    public class Animal : IAnimal
    {
        ...
        public void CreateNewAnimal(List<IAnimal> animals, List<ICustomer> customers)
        {
            ...
            IClaws clawCutting = Factory.CreateClowCutting();
            ...
            Console.WriteLine(" Vad är djurets namn?");
            ...
            if (customer != null)
            {
                ...
                Console.WriteLine("\n Djuret är registrerat\n");
            }
            else
            {
                Console.WriteLine("\n Hittar ingen kund med det namnet\n");
            }
        ...
        public void CheckOutAnimal(List<IAnimal> animals, IAnimal animal, IReceipt receipt, IStandardService standardService, IClaws clawCutting, IWash wash)
        {
            Console.WriteLine("\n ==== Ut Checkning ====\n");
            animal = GetAnimalByName(animals, animal);
